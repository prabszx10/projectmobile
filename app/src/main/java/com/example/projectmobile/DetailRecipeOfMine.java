...
public class DetailRecipeOfMine extends AppCompatActivity {
    String usernameedit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_recipe_of_mine);
        ...
        String keysusername= dataExtra.getString("keysusername");
        ref= FirebaseDatabase.getInstance().getReference().child("user").child(keysusername).child("ownrecipe");
