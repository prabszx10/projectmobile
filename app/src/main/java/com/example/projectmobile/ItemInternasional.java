...
public class ItemInternasional extends RecyclerView.Adapter<ItemInternasional.ViewHolder> {
    private Context context;
    private List<Internasional> items;
    View v;

    public ItemInternasional(List<Internasional>items) {
        this.items = items;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ItemInternasional.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        final Internasional item =items.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(v.getContext(), DetailInternasional.class);
